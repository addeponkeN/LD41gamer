...
namespace ld41gamer.Gamer.StateMachine
{
    ...
    public class GameState : State
    {
        ...
        public virtual void Draw(SpriteBatch sb, Camera cam)
        {
            ...
            {
                case GameStateType.Entering:
                    sb.Draw(UtilityContent.box, Globals.ScreenBox, new Color(Color.Black, (int)(255 * fadeInValue)));
                    lbTitle.Alpha = (int)(lbLife * 255);
                    lbTitle?.Draw(sb);
                    break;

                case GameStateType.Exiting:
                    sb.Draw(UtilityContent.box, Globals.ScreenBox, new Color(Color.Black, (int)(255 * fadeOutValue)));
                    break;
            }
